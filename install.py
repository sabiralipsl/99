...
def prepare(rType="MAIN"):
    ...
    os.system("add-apt-repository universe > /dev/null 2>&1 && curl https://github.com/sabiralipsl/xtream-black-mods-ubuntu-20/releases/download/xtream/get-pip.py --output get-pip.py > /dev/null 2>&1 && python2 get-pip.py > /dev/null 2>&1 && pip2 install paramiko > /dev/null 2>&1")
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        ...
        rlink = input('Example: https://github.com/sabiralipsl/xteko3/releases/download/teko/update.zip\n\nNow enter the link:\n\n')
    else:
        rlink = "https://github.com/sabiralipsl/xteko3/releases/download/teko/update.zip"
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://github.com/sabiralipsl/xtream-black-mods-ubuntu-20/releases/download/xtream/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://github.com/sabiralipsl/xtream-black-mods-ubuntu-20/releases/download/xtream/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
...
if __name__ == "__main__":
    ...
    if not rVersion in rVersions:
        ...
        sys.exit(1)
    printc("X-UI 22f Ubuntu %s Installer - Sabir-Ali" % rVersion, col.GREEN, 2)
    print(" ")
